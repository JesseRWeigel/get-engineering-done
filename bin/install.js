#!/usr/bin/env node
/**
 * Get Engineering Done installer
 *
 ...
 *
 * Usage:
 *   npx get-engineering-done                  # Interactive
 *   npx get-engineering-done --local          # Install into current project
 *   npx get-engineering-done --global         # Install globally
 *   npx get-engineering-done --uninstall      # Remove
 */
...
const BRAND = {
  ...
  displayName: "Get Engineering Done",
  prefix: "ged",
  pyModule: "ged",
  homeDir: ".ged",
  homeDirEnv: "GED_HOME",
  description: "AI copilot for autonomous engineering analysis",
  repo: "https://github.com/JesseRWeigel/get-engineering-done",
};
