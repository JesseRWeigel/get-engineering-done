...
Run diagnostic checks on the GED project and optionally fix issues.

### Checks

1. **Required files**: .ged/ directory exists, STATE.md, state.json, ROADMAP.md, config.json
...
- Initialize missing .ged/ subdirectories
