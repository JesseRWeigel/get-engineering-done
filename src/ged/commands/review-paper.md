...
1. **Existence check**: Does the cited work exist? Verify against:
   - IEEE Xplore, engineering standards databases (ASTM, ISO), Google Scholar, and Scopus
...
Load convention locks from .ged/conventions.json.
...
Spawn ged-referee with the manuscript. The referee runs 5 independent review perspectives:
...
#### 4f. Practical Feasibility Review
- Are the proposed designs/solutions physically realizable?
- Are safety factors and tolerances appropriate?
- Are material properties and constraints realistic?
- Does the solution meet relevant engineering standards?
