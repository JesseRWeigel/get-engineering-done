"""MCP server for GED error handling and observability.
...
from ged.core.constants import get_layout, ProjectLayout
from ged.core.observability import SessionLogger, TraceLogger

server = Server("ged-errors")
...
async def list_tools():
    return [
        ...
        Tool(
            name="ged_session_log",
            description="Log an event to the current session.",
            inputSchema={
                "type": "object",
                "properties": {
                    "event_type": {"type": "string", "description": "Event type (e.g., error, decision, verification, analysis)."},
