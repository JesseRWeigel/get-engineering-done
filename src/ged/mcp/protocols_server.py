"""MCP server for GED phase/plan protocols.

Exposes tools for parsing ROADMAP.md, computing dependency waves,
discovering plans, and managing the engineering analysis phase lifecycle.
"""
...
async def call_tool(name: str, arguments: dict):
    try:
        ...
        elif name == "ged_summaries_discover":
            layout = _layout(arguments.get("project_dir"))
