"""MCP server for GED convention lock management.

Exposes tools for locking, querying, and diffing engineering design
conventions (unit system, design code, safety factors, etc.).
"""
...
from ged.core.constants import get_layout, CONVENTION_FIELDS, ProjectLayout
from ged.core.state import StateEngine
from ged.core.conventions import (
    list_all_fields,
    check_conventions,
    diff_conventions,
...
async def list_tools():
    return [
        Tool(
            name="ged_conventions_list",
            description="List all engineering convention fields with descriptions and examples.",
            inputSchema={
                "type": "object",
                "properties": {},
            },
        ...
        Tool(
            name="ged_conventions_lock",
            description="Lock a convention field to a specific value (e.g., design_code = 'AISC 360-22').",
            inputSchema={
                "type": "object",
                "properties": {
...
async def call_tool(name: str, arguments: dict):
    try:
        ...
        elif name == "ged_conventions_diff":
            engine = _engine(arguments.get("project_dir"))
