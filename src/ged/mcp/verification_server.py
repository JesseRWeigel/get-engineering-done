"""MCP server for GED verification kernel.

Exposes tools for running content-addressed verification checks against
evidence registries (dimensional analysis, equilibrium, code compliance, etc.).
"""
...
from ged.core.constants import VERIFICATION_CHECKS
from ged.core.kernel import VerificationKernel, DEFAULT_PREDICATES, Severity

server = Server("ged-verification")
...
async def list_tools():
    return [
        ...
        Tool(
            name="ged_verify_list_checks",
            description="List all available engineering verification checks with their severity levels.",
            inputSchema={
                "type": "object",
                "properties": {},
            },
...
async def call_tool(name: str, arguments: dict):
    try:
        ...
        elif name == "ged_verify_list_checks":
            checks = []
